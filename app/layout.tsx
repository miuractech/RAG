      ...
      <body className="h-full" suppressHydrationWarning>
        <Providers>
          ...
          <div className="flex flex-col items-center h-full">
            ...
            <nav className="w-full sticky top-0 z-40 bg-background/95 backdrop-blur-sm border-b border-border">
                ...
                <div className="flex justify-between items-center h-16">
                  ...
                  <div className="flex items-center gap-8">
                    ...
                    >
                      ...
                      <span className="font-semibold text-lg hidden sm:block">Crownwell AI</span>
                    </Link>
                    
                    {/* Navigation Links */}
                    {user && (
                      <div className="hidden md:flex items-center gap-1">
                        <NavigationLink href="/files">
                          Files
                        </NavigationLink>
            ...
            <main className="w-full grow bg-background flex flex-col items-center overflow-hidden">
              {children}
            </main>
            <Toaster />
          </div>
